...
namespace Madonetr\Addresses\Traits;

use Madonetr\Addresses\Contracts\Address;
use Madonetr\Addresses\Exceptions\FailedValidation;
use Madonetr\Addresses\Models\Address as AddressModel;
